...
from elasticsearch_dsl import Boolean, DocType
from elasticsearch_dsl.faceted_search import DateHistogramFacet, FacetedSearch, RangeFacet, TermsFacet
...
class CommitSearch(FacetedSearch):
    ...
    facets = {
        ...
        'deletions': RangeFacet(field='stats.deletions',
